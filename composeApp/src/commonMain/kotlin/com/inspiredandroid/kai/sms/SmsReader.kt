...
/**
 * Multiplatform SMS reader. Only the Android build returns real data â€” the
...
expect class SmsReader() {
    /**
     * True when this build can ever read SMS at all â€” i.e. Android + `READ_SMS`
    ...
    /**
     * The current maximum inbox `_id`. Used to seed [com.kai.custom.data.SmsSyncState.lastSeenId]
