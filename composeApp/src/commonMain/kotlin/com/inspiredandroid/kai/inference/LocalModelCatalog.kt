...
// Qwen3 emits <think>â€¦</think> blocks as part of its chat template; strip them before
 ...
 * characters (U+10000â€“U+10FFFF â€” most emoji like ðŸ—ºï¸, ðŸŽ‰, ðŸ”¥) as surrogate-pair
 ...
 * code units in UTF-16) while leaving BMP characters â€” including BMP-only emoji like
 * âš”ï¸, â™»ï¸, â¤ï¸, and all CJK / extended Latin / accented characters â€” untouched.
