...
fun TerminalContent(
    ...
    // Reading selectedSessionId here â€” even though we don't use the value
    // directly â€” forces this composable to recompose when the user picks a
    ...
    Column(
        ...
        // â€” under heavy output, the per-line measure pass contends with the
