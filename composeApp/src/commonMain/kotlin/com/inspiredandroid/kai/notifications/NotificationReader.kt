...
/**
 * Multiplatform notification reader. Only the Android build returns real data â€”
 ...
 * â€” the listener service writes records there as they arrive.
 */
expect class NotificationReader() {
    /** True when this build can ever capture notifications â€” i.e. Android + listener registered. */
