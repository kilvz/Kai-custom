        ...
        data class Message(
            ...
            val effectiveContent: String?
                get() {
                    ...
                    // in the content field alongside structured tool_calls â€” strip them.
                    ...
                    if (cleaned.contains("</think>")) {
                        if (!cleaned.contains("<think>")) {
                            // Qwen3-Thinking omits opening <think> tag â€” everything before </think> is reasoning
             ...
             * `reasoning_content`, then return the same text in `content` â€” without this, the
