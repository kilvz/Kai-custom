...
data class ScheduledTask(
     ...
     * compatibility â€” legacy tasks decoded from storage without this field land on TIME,
     ...
     * Empty for HEARTBEAT-trigger tasks â€” those share the heartbeat-wide log instead.
     */
 ...
 *
 * - [TIME] â€” fires once at [ScheduledTask.scheduledAtEpochMs], transitions to COMPLETED.
 * - [CRON] â€” recurring; [ScheduledTask.cron] is the spec, [scheduledAtEpochMs] holds the
 *   next computed fire time. Stays PENDING; the scheduler advances it after each run.
 * - [HEARTBEAT] â€” a standing addition to every heartbeat self-check. Not picked up by
