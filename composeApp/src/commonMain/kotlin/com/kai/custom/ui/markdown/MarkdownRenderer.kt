...
import com.kai.custom.ui.markdown.math.MathFormula
...
fun MarkdownContent(
    ...
    val doc = remember(content) {
        runCatching { parseMarkdown(content) }.getOrElse {
            MarkdownDocument(persistentListOf(Paragraph(persistentListOf(com.kai.custom.ui.markdown.Text(content)))))
        }
    }
