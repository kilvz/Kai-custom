...
sealed class Service(
    ...
    data object SpAIder : Service(
        ...
        chatUrl = "http://localhost:8890/v1/chat/completions",
        modelsUrl = "http://localhost:8890/v1/models",
        sortModelsById = true,
        supportsImages = true,
        defaultModels = listOf(
            ModelDefinition(id = "spaider-lite", subtitle = "SpAIder Lite"),
            ModelDefinition(id = "spaider-lite-image", subtitle = "SpAIder Lite Image"),
            ModelDefinition(id = "spaider-lite-music", subtitle = "SpAIder Lite Music"),
            ModelDefinition(id = "spaider-lite-video", subtitle = "SpAIder Lite Video"),
            ModelDefinition(id = "spaider-lite-ext", subtitle = "SpAIder Lite Extended"),
            ModelDefinition(id = "spaider-lite-ext-image", subtitle = "SpAIder Lite Extended Image"),
            ModelDefinition(id = "spaider-lite-ext-music", subtitle = "SpAIder Lite Extended Music"),
            ModelDefinition(id = "spaider-lite-ext-video", subtitle = "SpAIder Lite Extended Video"),
            ModelDefinition(id = "spaider", subtitle = "SpAIder"),
            ModelDefinition(id = "spaider-image", subtitle = "SpAIder Image"),
            ModelDefinition(id = "spaider-music", subtitle = "SpAIder Music"),
            ModelDefinition(id = "spaider-video", subtitle = "SpAIder Video"),
            ModelDefinition(id = "spaider-research", subtitle = "SpAIder Research"),
            ModelDefinition(id = "spaider-ext", subtitle = "SpAIder Extended"),
            ModelDefinition(id = "spaider-ext-image", subtitle = "SpAIder Extended Image"),
            ModelDefinition(id = "spaider-ext-music", subtitle = "SpAIder Extended Music"),
            ModelDefinition(id = "spaider-ext-video", subtitle = "SpAIder Extended Video"),
            ModelDefinition(id = "spaider-ext-research", subtitle = "SpAIder Extended Research"),
            ModelDefinition(id = "spaider-pro", subtitle = "SpAIder Pro"),
            ModelDefinition(id = "spaider-pro-image", subtitle = "SpAIder Pro Image"),
            ModelDefinition(id = "spaider-pro-music", subtitle = "SpAIder Pro Music"),
            ModelDefinition(id = "spaider-pro-video", subtitle = "SpAIder Pro Video"),
            ModelDefinition(id = "spaider-pro-research", subtitle = "SpAIder Pro Research"),
            ModelDefinition(id = "spaider-pro-ext", subtitle = "SpAIder Pro Extended"),
            ModelDefinition(id = "spaider-pro-ext-image", subtitle = "SpAIder Pro Extended Image"),
            ModelDefinition(id = "spaider-pro-ext-music", subtitle = "SpAIder Pro Extended Music"),
            ModelDefinition(id = "spaider-pro-ext-video", subtitle = "SpAIder Pro Extended Video"),
            ModelDefinition(id = "spaider-pro-ext-research", subtitle = "SpAIder Pro Extended Research"),
        ),
    )
