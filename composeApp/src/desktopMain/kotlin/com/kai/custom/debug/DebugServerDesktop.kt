                ...
                post("/settings/{key}") {
                    ...
                    try {
                        ...
                        when (key) {
                            ...
                            "theme_mode" -> {
                                val mode = com.kai.custom.data.ThemeMode.entries.find { it.name.equals(v, ignoreCase = true) }
                    ...
                    call.respondText(
                        json.encodeToString(
                            buildJsonObject {
                                ...
                                put("error", JsonPrimitive("SMS not available on desktop"))
                            },
                        ),
                        ContentType.Application.Json,
                    )
                ...
                post("/chat") {
                    ...
                    val result = withContext(Dispatchers.Default) {
                        try {
                            ...
                            com.kai.custom.data.AskWithToolsResult("Error: ${e.message}")
                        }
                    }
