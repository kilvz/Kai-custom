 ...
 * All paths swallow failures â€” if the OS hook is missing the in-app heartbeat banner still fires.
 */
    ...
    try {
        when (currentPlatform as Platform.Desktop) {
            ...
            Platform.Desktop.Windows -> {
                ...
                // 1Ã—1 transparent placeholder â€” Windows auto-supplies a fallback icon for the toast.
        ...
        // notify-send missing, AWT headless, sandboxed osascript, etc. â€” fall back silently.
    }
}
