...
actual class MicrophonePermissionController actual constructor() {
...
@Composable
actual fun SetupMicrophonePermissionHandler(controller: MicrophonePermissionController) = Unit
