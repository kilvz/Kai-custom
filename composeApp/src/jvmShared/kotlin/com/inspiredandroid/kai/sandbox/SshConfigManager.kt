 ...
 * [com.kai.custom.tools.SshConfigureHostTool].
 *
 * Pure JVM file IO â€” no Android dependencies â€” so it can be unit-tested.
...
class SshConfigManager(private val homeDir: File) {
    ...
    // host/user/port/identity per remote â€” just without held connections.
