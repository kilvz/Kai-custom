...
import com.kai.custom.data.FallbackStatus
import com.kai.custom.data.FreeMode
import com.kai.custom.data.HeartbeatConfig
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(question: String?, files: List<PlatformFile>, uiSubmission: com.kai.custom.data.UiSubmission?) {
    ...
    override fun getSandboxDistro(): String = "alpine"
    ...
    override fun getNotificationSyncState(): com.kai.custom.data.NotificationSyncState = com.kai.custom.data.NotificationSyncState()
