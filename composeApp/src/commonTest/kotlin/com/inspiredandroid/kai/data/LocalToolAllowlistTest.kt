...
/**
 * Locks in the contract of [LOCAL_TOOL_ALLOWLIST] â€” the set of tools exposed to the
 ...
 *
 * Renaming a real tool (e.g. `memory_store` â†’ `save_memory`) without updating the
 * allowlist will silently drop the tool from the on-device path. This test fails loudly
 * in that case â€” the set literal below is the canonical expected list.
 */
