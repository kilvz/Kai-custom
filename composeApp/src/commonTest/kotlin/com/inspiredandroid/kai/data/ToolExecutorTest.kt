 ...
 * which requires the Koin DI container to be initialized â€” that machinery is exercised
...
class ToolExecutorTest {
    ...
    fun `formatJsonElement preserves string content with special characters`() {
        // Note: the implementation does not escape â€” it concatenates with quotes around content
