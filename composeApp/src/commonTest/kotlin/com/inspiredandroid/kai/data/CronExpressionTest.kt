...
class CronExpressionTest {
    ...
    fun `nextAfter specific day of week`() {
        ...
        // 2026-01-01 is Thursday â†’ next Sunday is 2026-01-04
    ...
    fun `nextAfter Monday morning`() {
        ...
        // From Sunday 2026-01-04 noon â†’ Monday 2026-01-05 7:00
    ...
    fun `nextAfter specific month and day`() {
        // Midnight Jan 1 â€” annual
        val cron = CronExpression("0 0 1 1 *")
        // From mid-year â†’ next Jan 1
    ...
    fun `nextAfter returns null when no match within search horizon`() {
        ...
        // Restricting to month=2 day=30 means no match in any year â†’ null after exhausting search.
    ...
    fun `nextAfter weekday range`() {
        ...
        // 2026-01-03 is Saturday â†’ next is Mon 2026-01-05 9:00
        assertEquals(instant(2026, 1, 5, 9, 0), cron.nextAfter(instant(2026, 1, 3, 0, 0), utc))
        // 2026-01-04 is Sunday â†’ next is Mon 2026-01-05 9:00
