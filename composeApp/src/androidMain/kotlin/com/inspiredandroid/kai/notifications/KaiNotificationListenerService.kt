 ...
 *
 * Per-app gating is handled by the system Notification Access "Apps" picker â€” if
 ...
 * - User toggle off â†’ drop. Lets the user pause capture without revoking access.
 * - Hard-blocked package (Kai itself, system UI) â†’ drop, avoids feedback loops.
 * - Ongoing/foreground-service notification (media controls, downloads) â†’ drop,
 *   these are sticky UI affordances, not events.
 * - `VISIBILITY_SECRET` â†’ drop, the user signalled the post should not appear on
