...
class WakeWordService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "onCreate â€” stack trace follows")
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Must call startForeground() before any early return â€” Android crashes with
    ...
    override fun onDestroy() {
        ...
        detectJob?.cancel()
        scope.cancel()
        // Release AudioRecord directly â€” scope.cancel() does NOT interrupt blocking read()
        val rec = audioRecord
        if (rec != null) {
            audioRecord = null
    ...
    private suspend fun listenLoop() {
        ...
        var readCount = 0
        var zeroCount = 0
        // Adaptive energy baseline â€” tracks ambient noise level (rain, fan, etc.)
        ...
        try {
            while (currentCoroutineContext().isActive) {
                ...
                if (read > 0) {
                    ...
                    // Compute energy of this frame â€” skip silent/low frames
                    var energy = 0f
                    for (i in 0 until read) {
