...
The SSH connection is persistent â€” managed by the user or set up via the ssh_connect/ssh_disconnect tools. The connection stays alive across commands so state (cwd, exports, etc.) carries forward from one call to the next, just like a normal terminal.
...
- Fullscreen TUIs will not work â€” use non-interactive variants."""
