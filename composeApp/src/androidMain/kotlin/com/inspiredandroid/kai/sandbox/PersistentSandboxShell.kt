...
class PersistentSandboxShell(
    ...
    fun cancelForeground() {
        val pid = bashPid
        if (pid == null) {
            // No pid captured yet â€” the user expects cancel to actually do
        ...
        scope.launch {
            ...
            // Even SIGKILL didn't free us â€” the shell itself must be wedged.
            reset()
        }
    }
    ...
    private fun ensureShell() {
        ...
        // the sentinel pattern below â€” flushes any partial line first.
    ...
    private fun dispatchStderr(line: String) {
        ...
        // Startup pid probe â€” handled regardless of whether a sink is active.
