...
import com.inspiredandroid.kai.shizuku.ShizukuManager
...
import com.inspiredandroid.kai.tools.AdbTool
import com.inspiredandroid.kai.tools.OpenCodeTool
import com.inspiredandroid.kai.tools.OpenFileTool
import com.inspiredandroid.kai.tools.PhoneTools
...
import com.inspiredandroid.kai.tools.SpeakTextTool
import com.inspiredandroid.kai.tools.SmsTools
import com.inspiredandroid.kai.tools.SshCommandTool
import com.inspiredandroid.kai.tools.SshConfigureHostTool
import com.inspiredandroid.kai.tools.SshConnectTool
import com.inspiredandroid.kai.tools.SshDisconnectTool
...
// Uses dev.spght:encryptedprefs-ktx â€” a maintained community fork of the deprecated
...
private fun createEncryptedPrefs(context: Context): android.content.SharedPreferences {
    ...
    // Phone tools â€” full device access
    ...
    // UI â€” `getAvailableTools()` never consulted them.
}
...
actual fun getAvailableTools(): List<Tool> {
    ...
    return buildList {
        ...
        // These only *stage* drafts â€” actual sending is user-triggered via the review banner.
