...
import com.inspiredandroid.kai.mcp.AltMemoryLifecycleManager
...
class AndroidSandboxController : SandboxController {
    ...
    init {
        ...
        // collector below catches up. Skip the disk-usage walk in this fast path â€”
    ...
    override suspend fun executeCommandStreaming(
        ...
        // No implicit timeout in the streaming path â€” UI cancel + process exit
    ...
    // â”€â”€ memory semantic search â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
